...
/***/ (function(module, exports, __webpack_require__) {
	...
	function addCheckedFoods(foodIds, meal) {
	...
	function getFoodForMeal(meal) {
	  return $.ajax({ type: "GET", url: `${appURL}/api/meals/${meal}`, success: function (data) {
	      return data;
	    },
	    error: function (data) {
	      return [null];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3).setImmediate, __webpack_require__(5), (function() { return this; }()), __webpack_require__(6)(module)))
